...
genai.configure(api_key="AIzaSyDJOZpV3rNBgl3RQaX_ToupLSdjjFoVHAU")
...
st.set_page_config(page_title="Pritam's Invoice Generator")
st.sidebar.header("RoboBill")
st.sidebar.write("Made by Pritam")
st.sidebar.write("Powered by Google Gemini AI")
st.header("Robobill")
st.subheader("Made by Pritam")
...
input_prompt = """
You are an expert in reading invoice. We are going to upload an image of an in
and you will have to answer any type of question that the user asks you.
